...
👉 [Postman koleksiyonu]([./postman/VetApp.postman_collection.json](https://github.com/eneszeybek/veterinary-management-system/blob/main/eneszeybek_vetapp_postman_collection.json)) dosyasını kullanarak test edebilirsiniz.
